...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
    ...
    $result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records FROM user WHERE sourse= 'sai-balaji-group'");
    $total_records = mysqli_fetch_array($result_count);
    $total_records = $total_records['total_records'];
    $total_no_of_pages = ceil($total_records / $total_records_per_page);
    $second_last = $total_no_of_pages - 1; // total page minus 1

    $result = mysqli_query($conn,"SELECT * FROM user WHERE sourse= 'sai-balaji-group' ORDER BY userid DESC LIMIT $offset, $total_records_per_page");
    echo '11111111111111     '.mysqli_num_rows( $result);
