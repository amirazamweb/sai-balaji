...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
    ...
    $result = mysqli_query($conn,"SELECT * FROM `posts` ORDER BY id DESC LIMIT $offset, $total_records_per_page");
    ...
    ?>
                <tbody>
                   ...
                   <a href="update-link.php?id=<?php echo $row["id"]; ?>" class="btn btn-info">edit</a>
